...
public class FPS_Displayer : MonoBehaviour
{
    ...
    {
        Rect rect = new Rect(0, 120, this.width, this.height * 3 / 100);
        this.style.alignment = TextAnchor.UpperLeft;
        this.style.fontSize = this.height * 2 / 100;
        this.style.normal.textColor = Color.yellow;
    ...
    {
        Rect rect = new Rect(0, 170, this.width, this.height * 3 / 100);
        this.style.alignment = TextAnchor.UpperLeft;
        this.style.fontSize = this.height * 2 / 100;
        this.style.normal.textColor = Color.yellow;
    ...
    {
        Rect rect = new Rect(0, 220, this.width, this.height * 3 / 100);
        this.style.alignment = TextAnchor.UpperLeft;
        this.style.fontSize = this.height * 2 / 100;
        this.style.normal.textColor = Color.yellow;
